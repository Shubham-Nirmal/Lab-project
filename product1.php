...
if ($product_id > 0) {
    // Modify your SQL query to fetch the product by id
    ...
    // Invalid product id, handle this case
...
.pf-details .image-container {
    text-align: center;
}

.pf-details .text-container {
    padding: 20px;
}

.pf-details .pdf-container {
    text-align: center;
    margin-top: 15px;
}
...
.pf-details .pdf-icon {
    ...
    color: #dc3545; /* Color for PDF icon */
    display: block;
    margin: 0 auto;
}

.pf-details .pdf-container a {
...
.pf-details .social-media-container {
    margin-top: 15px;
}

.pf-details .social-media-container a {
    color: #343a40;
    margin: 0 10px;
    text-decoration: none;
}
...
/* Ensure the carousel adapts to various screen sizes */
.owl-carousel .item {
    display: flex;
    align-items: center;
    justify-content: center;
                    ...
                    <div class="col-lg-8 text-center text-lg-start mb-lg-0">
                        <div class="d-flex flex-wrap">
                            <div class="border-end border-primary pe-3">
                                <a href="tel:+ 0123 456 7890"><span class="text-dark">+91 8806973003</span></a>
                            </div>
                            <div class="ps-3">
                                <a href="mailto:example@gmail.com" class="text-muted small"><i class="fas fa-envelope text-primary me-2"></i>labservindia@gmail.com</a>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light" style="text-align: center;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse" style="justify-content: center;">
                        <div class="navbar-nav" style="font-size: 18px; display: flex; align-items: center;">
                            ...
                            <a href="product.php" class="nav-item nav-link active" style="margin: 0 15px;">Products</a>
                            <!-- <a href="blog.php" class="nav-item nav-link" style="margin: 0 15px;">Blog & Events</a> -->
...
<section class="pf-details section" style="margin-top: -100px;">
    <div class="container" style="padding-top: 0; margin-top: 0;">
        <div class="row d-flex align-items-center" style="min-height: 100vh; margin-top: 0;">
            <div class="col-md-6 d-flex justify-content-center align-items-center">
                <div class="image-container">
                    <?php 
                    $uploadedImagePath = 'Admin/uploaded_images/' . $info['photo'];
                    ?>
                    <!-- Check if the image exists before displaying -->
                    <?php if (!empty($info['photo']) && file_exists($uploadedImagePath)): ?>
                        <img 
                            src="<?php echo htmlspecialchars($uploadedImagePath); ?>" 
                            alt="<?php echo htmlspecialchars($info['photo']); ?>" 
                            class="img-fluid" 
                            style="width: 80%; max-height: 500px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); object-fit: contain; margin-top: 0;"
                        >
                    <?php else: ?>
                        <p style="color: red;">Image not found: <?php echo htmlspecialchars($uploadedImagePath); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-md-6 d-flex flex-column justify-content-center">
                <div class="text-container text-center">
                    <h2 style="color: #015fc9;"><?php echo htmlspecialchars($info['name']); ?></h2>
                    <p>Discover more about our high-quality <?php echo htmlspecialchars($info['name']); ?>. Learn about the features and specifications that make it an excellent choice for your needs.</p>
                    <p>You want to know more, download the PDF below:</p>
                    
                    <div class="pdf-container">
                        <i class="fas fa-file-pdf pdf-icon" style="font-size: 40px; display: block; margin: 0 auto;"></i>

                        <?php if (!empty($info['pdf']) && file_exists('Admin/uploaded_pdfs/' . $info['pdf'])): ?>
                            <a href="Admin/uploaded_pdfs/<?php echo htmlspecialchars($info['pdf']); ?>" target="_blank">View PDF</a>
                        <?php else: ?>
                            <p style="color: red;">PDF not found.</p>
                        <?php endif; ?>

                        <a href="service.php" class="btn mt-2" style="display: block; margin: 10px auto; background-color: #015fc9; color: white; width: 200px; text-align: center;">
                            Explore More
                        </a>
                    </div>
                </div>
...
<?php
// Assuming the product_id is passed via GET, e.g., ?product_id=1
$product_id = isset($_GET['id']) ? intval($_GET['id']) : 0;

// Fetch product details from the database
$sql = "SELECT name, description, specification FROM products WHERE id = ?";
...
<div class="container" style="margin-top: -70px;">
    ...
    <button class="nav-link active border-white border-bottom-0 tab-btn" type="button" role="tab"
            id="nav-details-tab" data-bs-toggle="tab" data-bs-target="#nav-details"
            aria-controls="nav-details" aria-selected="true">Product Details</button>
    <button class="nav-link border-white border-bottom-0 tab-btn" type="button" role="tab"
            id="nav-specifications-tab" data-bs-toggle="tab" data-bs-target="#nav-specifications"
            aria-controls="nav-specifications" aria-selected="false">Product Specifications</button>
</div>
...
.nav-tabs .tab-btn:focus {
    ...
    box-shadow: 0 0 5px rgba(0, 123, 255, 0.5);
        ...
        <div class="tab-content mb-5">
            <!-- Product Details Tab -->
            <div class="tab-pane fade show active" id="nav-details" role="tabpanel" aria-labelledby="nav-details-tab" style="padding: 15px;">
                <div style="border: 1px solid grey; border-radius: 8px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.5); background-color: #fff; margin-bottom: 20px;">
                    <div class="px-2">
                        <div class="row g-4 justify-content-center">
                            <div class="col-md-11">
                                <div class="row bg-light align-items-center text-center py-3" style="border: 1px dotted #ddd; margin-bottom: 15px;">
                                    <div class="col-12">
                                        <p class="mb-2" style="font-weight: bold; font-size: 1.1em; color: #015fc9;">Product Details</p>
...
<!-- Product Specifications Tab -->
<div class="tab-pane fade" id="nav-specifications" role="tabpanel" aria-labelledby="nav-specifications-tab" style="padding: 15px;">
    <div style="border: 1px solid grey; border-radius: 8px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.5); background-color: #fff; margin-bottom: 20px;">
        <div class="px-2">
            <div class="row g-4 justify-content-center">
                <div class="col-md-11">
                    <div class="row bg-light align-items-center text-center py-3" style="border: 1px dotted #ddd; margin-bottom: 15px;">
                        <div class="col-12">
                            <p class="mb-2" style="font-weight: bold; font-size: 1.1em; color: #015fc9;">Product Specifications</p>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($specifications as $spec) {
                                        $spec = trim($spec); // Remove extra spaces
                                        if (!empty($spec)) {
                                            $parts = explode(":", $spec, 2);
                                            if (count($parts) === 2) {
                                                $item = htmlspecialchars(trim($parts[0]));
...
<div class="related-products-container">
    <h2 style="color: #015fc9; font-size: 35px;">Related Products</h2>

    <div class="related-products-box">
    <div class="owl-carousel">
        <div class="item">
            <div class="product-box">
                <img src="https://www.martinmicroscope.com/wp-content/uploads/2020/03/Olympus-SZ61-AVIOR.jpg" alt="Product 1">
                <h3>Product 1</h3>
            </div>
        </div>
        <div class="item">
            <div class="product-box">
                <img src="https://th.bing.com/th/id/OIP.R_pHGEzsRIQPzXbQ9jLRaAHaIY?w=500&h=566&rs=1&pid=ImgDetMain" alt="Product 2">
                <h3>Product 2</h3>
            </div>
        </div>
        <div class="item">
            <div class="product-box">
                <img src="https://th.bing.com/th/id/OIP.jCFQYw1B8KSfcuEouf1D3QHaHa?rs=1&pid=ImgDetMain" alt="Product 3">
                <h3>Product 3</h3>
            </div>
        </div>
        <div class="item">
            <div class="product-box">
                <img src="https://cdn.shopify.com/s/files/1/0072/4412/0152/products/BX53M_800x.jpg?v=1561564448" alt="Product 4">
                <h3>Product 4</h3>
            </div>
        </div>
    </div>
...
<style>
.related-products-box .product-box {
